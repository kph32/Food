...
function getShopList(){
	...
	var url = "getshopResult.php";

	xhr.open("Get", url, true);
	xhr.send( null );
}
function showShopList(jsonStr){
  	// alert(jsonStr);
...
function getShopListCoupon(){
	...
	// var url = "getshopResult03.php?shop_place=" + $_SESSION["SearchBox-place"]",shop_miniplace=" + $_SESSION["SearchBox-miniplace"];
	var url = "getshopResultCoupon.php";

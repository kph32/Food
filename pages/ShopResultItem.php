...
$member_id = $_SESSION['mem']['member_id'];
...
if ($shop_message != '') {
    $stmt = $conn->query("INSERT INTO mem_message (`message_id`,`name`,shop_message,message_date,is_delete,shop_id,member_id)
 VALUES ('$message_id','$name','$shop_message','$message_date','0','$shop_id','$member_id')");
...
function insertMessage($message_id){
    $report_id = $_POST['message_id'].time();

    $shop_message = $_POST['shop_message'];
    ...
    // $conn = new mysqli('localhost', 'root', 'fzwV9d4G', 'foodie');
        $conn = new mysqli('localhost', 'ad105g2', 'ad105g2', 'ad105g2');
...
// Check connection
    ...
    $stmt = $conn->query("INSERT INTO `report` (`report_id`,`content`,`is_delete`,`create_date`,`member_id`,`shop_id`,`message_id`)
 VALUES ('$report_id','$shop_message','0','$message_date','$member_id','$shop_id','$message_id')");
...
$sql = "select s.coupon, p.image2, s.shop_name from photofilm p, shop s where s.shop_id = :shop_id and p.shop_id = s.shop_id";
...
<?php
    if($prod["coupon"]==1){
?>
                    <li><a href="ShopResultItembuy.php"><img src="../assets/images/shopresultitem/shopresultitem_orderbb.png" alt="優惠券"/></a>
                    </li>
<?php
    }else{
            ...
            <div class="ShopResultItem-InfoTop">
                ...
                <div class="ShopResultItem-People bounce">
                    <ul>
                        ...
                        // 連到這個資料夾
                        require_once("../common/connectFoodie.php");
                        $sql = "select s.coupon, s.shop_video_id, s.videoword, s.menuword1, s.menuword2, p.image1, p.image2, p.image3, p.image4, p.image5, s.announcement, s.browser_num, s.createdate, s.menu from photofilm p, shop s where s.shop_id = :shop_id and p.shop_id = s.shop_id";
                        $products = $pdo->prepare($sql);
...
?>
        ...
        <div class="ShopResultItem-Infomation col-sm-10 col-xs-10">
            ...
            <div class="ShopResultItem-Message">
                        ...
                        <div class="ShopResultItem-MessagePlace">
                            ...
                            <div class="ShopResultItem-MessageCheck">
                                ...
                                <input type="hidden" name="message_id"
                                       value="<?php echo $mem_messageRow["message_id"]; ?>">
                                <input type="hidden" name="shop_message"
                                       value="<?php echo $mem_messageRow["shop_message"]; ?>">
                                <input type="hidden" name="message_date"
                                       value="<?php echo $mem_messageRow["message_date"]; ?>">
                                <input type="hidden" name="member_id"
                                       value="<?php echo $mem_messageRow["member_id"]; ?>">
                                <input type="hidden" name="shop_id"
                                       value="<?php echo $mem_messageRow["shop_id"]; ?>">

                                <input type="hidden" name="action" value="message">
                                <button type="submit" class="message">檢舉</button>
                            </div>
                            </form>
                ...
                if ($_SESSION['mem']['member_id'] == "") {
                    echo "留言請登入";
                } else {


                    echo "<div class='ShopResultItem-MessagePlace'>";
                    echo "<div class='ShopResultItem-MessageImage'>";
                    echo "<img src='../assets/images/shopresultitem/shopresultitem_beau.jpg'>";
                    echo "</div>";



                    echo "<div class='ShopResultItem-MessageWordList'>";
                    echo "<div class='ShopResultItem-MessageName'>";
                    echo $_SESSION['mem']['name'];
                    echo "</div>";

                    echo "<div class='ShopResultItem-MessageTime'>";
                    echo "</div>";
                    echo "</div>";
                    echo "<div class='ShopResultItem-MessageCheck'>";
                    echo "</div>";
                    echo "<div class='clearfix'></div>";
                    echo "<div class='ShopResultItem-MessageFloor'>";
                    echo "</div>";
                    echo "<div class='ShopResultItem-MessageReback'>";
                    echo "<form action='' method='post'>";
                    echo "<input name='shop_message' type='text' value='' placeholder='回覆...' class='ShopResultItem-MessageTest'/> ";

                    echo "<a href='#content'> <input type='submit' value='送出' class='ShopResultItem-MessageSubmit'>";
                    echo "</a>";
                    echo "</form>";
                    echo "</div>";
